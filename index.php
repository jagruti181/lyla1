...
<head ng-controller="headerctrl">
    ...
    mixpanel.init("adb4a5f089deeab61c0fecdfc4853d78");</script><!-- end Mixpanel -->
...
<!--        <div ng-view skrollr-tag></div>-->
    ...
    <script type="text/javascript">try{ clicky.init(100777994); }catch(e){}</script>
    <noscript><p><img alt="Clicky" width="1" height="1" src="//in.getclicky.com/100777994ns.gif" /></p></noscript>
